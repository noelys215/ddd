  ...
  return (
    <Layout title="arbiter_fullstack_platform">
      <main className="w-full">
          ...
          <div className="grid items-end gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-12">
            <div>
              ...
              <p className="mt-5 max-w-xl text-sm leading-relaxed text-white/70 md:text-base">
                Arbiter gives groups one shared space to build a watchlist, set
                the mood, decide together, and preserve the night after the
                winner moves into a Teleparty watch session.
              </p>
              ...
              <dl className="mt-8 grid gap-x-6 gap-y-4 border-y border-white/10 py-5 text-sm sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-white/80">Live, actively developed</dd>
                </div>
              </dl>
        ...
        <CaseStudySection id="problem-heading" title="The Problem">
          <div className="mx-auto max-w-3xl space-y-5 text-base leading-relaxed text-white/75 md:text-lg">
            ...
            <p>
              ...
              result becomes part of the group’s history instead of disappearing
              with the poll.
            </p>
          </div>
          <FlowDiagram
        ...
        <CaseStudySection id="walkthrough-heading" title="Product Walkthrough">
        ...
        >
          <p className="mx-auto max-w-2xl text-center text-sm leading-relaxed text-white/60 md:text-base">
            Three decisions shaped Arbiter more than any individual component or
            endpoint.
          </p>
          <div className="mt-10">
        ...
        <CaseStudySection id="architecture-heading" title="Architecture">
          <div className="mx-auto max-w-3xl space-y-4 text-center text-sm leading-relaxed text-white/70 md:text-base">
            ...
            <p>
              PostgreSQL stores the social graph, watchlists, active decisions,
              and immutable completion snapshots. Redis coordinates distributed
              abuse limits; TMDB, Google, Resend, OpenAI, and Teleparty remain
              bounded external integrations rather than sources of authority.
            </p>
          </div>
          <ArchitectureDiagram />
        </CaseStudySection>

        <CaseStudySection id="quality-heading" title="Quality & Production Readiness">
        ...
        <CaseStudySection id="notes-heading" title="Engineering Notes">
        ...
        <CaseStudySection id="reflection-heading" title="Outcome & Reflection">
          <div className="grid gap-10 md:grid-cols-2 md:gap-14">
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/75 md:text-base">
                ...
                setup, synchronized voting, Teleparty handoff, durable History,
                explainable Insights, shareable keepsakes, and first-time
                guidance. Each surface rests on the same group and session
                model instead of becoming a disconnected feature.
              </p>
            </div>
            <div>
              <p className="font-mono text-xs uppercase tracking-[0.18em] text-pink-400">
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/75 md:text-base">
                ...
                becoming its state model, snapshots can preserve history without
                copying entire upstream payloads, and playful analytics can stay
                credible when every sentence is traceable to a rule. The same
                discipline guided the HeroUI migration, security work, and the
                decision to defer features until their foundations were ready.
              </p>
            </div>
          </div>
        </CaseStudySection>
